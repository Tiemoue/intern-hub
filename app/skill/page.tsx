...
const page = () => {
    ...
    return (
        ...
        <div className="container mx-auto my-8 p-4">
            <h1 className="text-xl font-semibold text-center mb-10">Select a Skill You Have or Enjoy Working With</h1>
            <div className='flex items-center p-4'>
                ...
                <div className='w-96 overflow-hidden rounded-2xl border shadow-xl  p-4 flex-none'>
                    <h2 className="text-lg font-semibold mb-2 text-center">Selected Skills</h2>
